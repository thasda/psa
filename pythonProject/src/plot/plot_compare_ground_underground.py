...
def plot_compare_ground_underground(
    ...
    ground_targets = ['Ey', 'Bx', 'Bz', 'By', 'Ex']
    underground_targets = ['ch1', 'ch2', 'ch0', 'ch4', 'ch3']
...
if __name__ == '__main__':
    ...
    # # 绘制全部数据
    # plot_compare_ground_underground(input_file1, input_file2)

    # 或者只绘制特定时间段（例如前30秒）
    plot_compare_ground_underground(
        input_file1,
       input_file2,
        start_time='2022-11-05 02:18:30.000000',
        end_time='2022-11-05 02:18:40.000000',
